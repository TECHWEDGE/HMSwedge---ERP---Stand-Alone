	 ...
	 if(user.includes("[ROLE_DISPSALESMANAGER]")){
		...
		var url = "/ERP/hmspharma1" ;
		 ...
		 document.getElementById("bouton-contact").disabled = true; 
			...
			$('#fh').text('Dispensary Purchase Entry')
			$('.navbar-brand').text('Dispensary Purchase Entry')
	}
	
		else if(user.includes("[ROLE_DISPPHARMACIST]")){
...
function datasuccess(data){
	...
	if(data != "null"){
		...
		alert(data)
window.location = "/ERP/dpurchaseho.html";
	}
}
...
function setUrl(myurl){
	...
	$('#vp').attr("href","/ERP/dprpur?allo="+url+"");
}
...
var cps;
       function doAjaxPost2(batch,name) {
    	   ...
    	   $.ajax({
	           ...
	           url: "/ERP/dgetBatdet?location="+encodeURIComponent(batch)+"&&location1="+encodeURIComponent(name)+"",
	          data: "0",
    ...
    <a class="navbar-brand" >Purchase Entry </a>
     ...
     <ul class="nav navbar-nav">
      ...
      <li class="dropdown" id="dr1">
        ...
        <li class="pra"><a href="/ERP/manufactureho.html">Manufacturer Master</a></li>
       <li class="pra"><a href="/ERP/supplierho.html">Supplier Master</a></li>
       <li class="pra"><a href="/ERP/customerho.html">Customer Master</a></li>
       <li><a href="/ERP/productho.html">Product  Master</a></li>
       </ul>
     
      <li class="pra"><a href="/ERP/orderho.html">Order & Reorder</a></li>
        <li class="pra"><a href="/ERP/purchaseho.html">Purchase Entry</a></li>
        <li class="pra"><a href="/ERP/saleho.html">Sales</a></li>
        <li class="pra"><a href="/ERP/stopriceho.html">Product Stocks and Pricing</a></li>
       ...
       <li><a href="/ERP/dcustomerho.html">Customer Master</a></li>
       <li id="dpma"><a href="/ERP/productho.html">Product  Master</a></li>
        <li id="dpe"><a href="/ERP/dpurchaseho.html">Purchase Entry</a></li>
  ...
  <div id="form1" >  
     ...
     <h1>
	  ...
	  <span class="fa fa-refresh"></span> Refresh</button> <a href="#" target="_blank" id="vp" class="btn btn-warning button2 rmt" onclick="return checkUrl(this)">Print</a>
       ...
       <font size="5" id="fh">Purchase Entry </font><span class="button2"><i class="" style="color:#ff9900;margin: 4px 8px;"></i>
...
<form id="purchasesave" action="dpurchaseSaveho.html" method="post"></form>
      <div id="col3">
     ...
     <select class="selectpicker" data-dropup-auto="false" data-show-subtext="true" data-live-search="true"  name = "supplier" id ="Supplier"  onchange="doAjaxPost(this.value);this.selectedindex = -1" required>
  ...
  <div class="col-xs-1"></div>
	      ...
	      <div class="col-xs-3">
	       <div class="form-group">
	        ...
	        <p>Code<span></span></p>
      <select class="selectpicker" data-dropup-auto="false" form="ui" data-show-subtext="true" data-live-search="true" name = "ean" id ="ean"  onchange="add1()" required>
   ...
   <p>Product<span></span></p>
      <select class="selectpicker" data-dropup-auto="false" form="ui"  data-show-subtext="true" data-live-search="true" name = "pname" id ="pname"  onchange="add2()" required>
       <option value="Select">New</option>
     </select>
	       </div>
	       </div>
