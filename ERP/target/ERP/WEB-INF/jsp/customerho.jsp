...
function datasuccess(data){
	...
	if(data != "null"){
		...
		alert(data)
window.location = "/ERP/customerho.html";
	}
}
</script>
<script>
...
<nav class="navbar navbar-default">
    ...
    <div class="navbar-header">
     ...
     <ul class="nav navbar-nav">
      ...
      <li class="dropdown" id="dr1">
        ...
        <li id="mm"><a href="/ERP/manufactureho.html">Manufacturer Master</a></li>
       <li id="sm"><a href="/ERP/supplierho.html">Supplier Master</a></li>
       <li id="cm"><a href="/ERP/customerho.html">Customer Master</a></li>
       <li id="pm"><a href="/ERP/productho.html">Product  Master</a></li>
         
        </ul>
      
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown">Transaction
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown">Stocks/Transfer
        <span class="caret"></span></a>
        <ul class="dropdown-menu">
  ...
  <div id="form2" >  
     ...
     <h1><button type="button" id="refresh" class="btn btn-warning button1" onclick="location.href='/ERP/customerho.html';">
...
<div class="col-xs-4"></div>
  ...
  <div class="form-group">
      ...
      <select class="selectpicker" data-size="5" data-dropup-auto="false" data-show-subtext="true" data-live-search="true" name = "" id ="customer2"  onchange = "update()"required>
