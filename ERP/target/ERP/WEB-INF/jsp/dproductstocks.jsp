...
tbody{
 ...
 function checkhome2(user){
      ...
      */
		...
		$('.tra').hide();
		$('.sta').hide();
		$('#fh').text('Dispensary Product Stocks & Pricing')
		$('.navbar-brand').html('Dispensary Product Stocks <br/> & Pricing')
 	}
 	 

 	 else if(user == "[ROLE_SALESMANAGER]"){
...
function datasuccess(data){
	...
	if(data != "null"){
		...
		alert(data)
window.location = "/ERP/dstopriceho.html";
	}
}
...
function fetchSearchResults(){
    var uri = "/ERP/dispsearchProductStocks"
    var databody = {
      "name" : $("#name").val(),
      "code" : $("#code").val(),
...
<nav class="navbar navbar-default navbar-fixed-top" id="myHeader">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
       ...
       <li><a href="/ERP/productho.html">Product  Master</a></li>
      	  ...
      	  <li class="dropdown navhover tra">
        ...
        <li id="sal"><a href="/ERP/saleho.html">Sales</a></li>			    
      	  	  ...
      	  	  <li class="dropdown navhover sta">
        ...
        <li id="stktrns"><a href="/ERP/branchtransfer.html">Stocks Transfer</a></li>	    
      	  ...
      	  <li class="dropdown navhover"  id="dr2">
        		...
        		<span class="caret"></span></a>
			        <ul class="dropdown-menu">
			         <li id="dpsp"><a href="/ERP/dstopriceho.html">Dispensary Product Stocks and Pricing</a></li>
			         <li id="ds"><a href="/ERP/dsaleho.html">Dispensary Sales</a></li>		    
			        </ul>
      	  </li>
  ...
  <div id="form2a" >  
     ...
     <h1>
     <font size="4" id="fh">Product Stocks and Pricing </font><span class="button2"></span><i class="" style="color:#ff9900;margin: 4px 8px;"></i>
...
<c:set var="today" value="<%=new java.util.Date()%>" />
      <div id="col3">
       ...
       <form:form id="form2" method="post" modelAttribute="productStocks" action="saveDispProductStocks.html"></form:form>
     <form id ="form1" class="" method="get" action="dpssearchho.html">
  ...
  <a href="/ERP/dstopriceho.html" class="btn btn-primary" role="button">Refresh</a>
	...
	<div class="container" id="span2">
      <jsp:include page="DispProductStockTableComponent.jsp" />
   </div>
<br>
     <div class="form-group row" >
