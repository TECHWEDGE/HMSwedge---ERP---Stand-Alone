...
var subtotalsum = 0;
	...
	function getPurchaseData(){
		...
		var url="/ERP/reports/purchaseData"
		var data={
	...
	function getReport(){
		var data={
		 ...
		 $.ajax({
	           type: "GET",
	           url: "/ERP/reports/purchaseReport",
	           data: data,
	           ...
	           success: function(response){
        			...
        			$('#getreport').attr("href", "/ERP/reports/purchaseReport"+"?fromDate="+data.fromDate+"&toDate="+data.toDate);
	          		$('#getreport')[0].click();
	   			},
	            error: function(e){
...
<div class = "wrapper">
 ...
 <div id="form2a" >    
     <h1><font size="5" class = "psp">Purchase Report</font><span class="button2"></span><i class="" style="color:#ff9900;margin: 4px 8px;"></i></h1>
	 <br>
	...
	<div class="container table-container">
		...
		<div style="float: right;padding-right: 3%;padding-top: 1%;"><b>Grand Total : <span type="text" id="totalsum"></span></b></div>
	<br><br><br>
</div>
</div>
